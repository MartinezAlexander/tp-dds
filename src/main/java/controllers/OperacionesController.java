...
public class OperacionesController implements WithGlobalEntityManager, TransactionalOps {
    ...
    public Void crearOperacion(Request req, Response res) {
        ...
        String presupuestos_json = req.queryParams("etiquetas");
        int[] presupuestos_id = new Gson().fromJson(presupuestos_json, int[].class);
//
//        System.out.println("*********************************************************************************************");
//        System.out.println("*********************************************************************************************");
//        System.out.println("------------------------------------------------ CATEGORIAS: " + cats[0]);
//        System.out.println("*********************************************************************************************");
//        System.out.println("*********************************************************************************************");
...
//        System.out.println("################################ cats existe: " + (cats != null));
        System.out.println("####################################################################################");
...
//            operacionDeEgreso.agregarEtiqueta(etiqueta);
        ...
        System.out.println("####################################################################################");
        for (int presupuesto : presupuestos_id){
//            operacionDeEgreso.agregarEtiqueta(etiqueta);
